...
class Valida
{
    ...
    protected function set_messages_default(){
        $this->_messages = array(
            ...
            'is_match'       => 'O campo <strong>%s</strong> está diferente do campo <strong>%s</strong>', 
            'is_unique'      => 'Este <strong>%s</strong> já está cadastrado em nossos sistema!', 
            ...
            'is_phone'       => 'O campo <strong>%s</strong> não é um telefone válido',
            'is_zipCode'     => 'O campo <strong>%s</strong> não é um CEP válido',
    ...
    public function is_match($campo)
    {
     ...
     public function is_unique($campo, $id = null) {

        if ($id) {
            $dados = $this->model::find($id);
            if ($dados->email == $this->_data['value']) {
                return $this;
            } else {
